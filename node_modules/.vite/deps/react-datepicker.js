...
function parse(dirtyDateString, dirtyFormatString, dirtyReferenceDate, options) {
  ...
  try {
    ...
    for (_iterator.s(); !(_step = _iterator.n()).done; ) {
      var _ret = _loop();
      if (_typeof37(_ret) === "object") return _ret.v;
    }
  } catch (err) {
    _iterator.e(err);
  } finally {
...
function Ce(e3) {
  return (function(e4) {
    if (Array.isArray(e4)) return _e(e4);
  })(e3) || (function(e4) {
    if ("undefined" != typeof Symbol && null != e4[Symbol.iterator] || null != e4["@@iterator"]) return Array.from(e4);
  })(e3) || (function(e4, t3) {
    if (!e4) return;
    if ("string" == typeof e4) return _e(e4, t3);
    ...
    if ("Arguments" === r2 || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(r2)) return _e(e4, t3);
  })(e3) || (function() {
...
function xt(e3, t3) {
  for (var r2 = [], n = We(e3), o = We(t3); !isAfter(n, o); ) r2.push(Ye(n)), n = addMonths(n, 1);
  return r2;
}
...
var Ht = (function(t3) {
  ...
  function o(t4) {
    ...
    return he(this, o), ye(ke(a3 = n.call(this, t4)), "handleClickOutside", (function(e3) {
      ...
      if (a3.props.showYearDropdown && !t5) return import_react2.default.createElement(Pt, { adjustDateOnChange: a3.props.adjustDateOnChange, date: a3.state.date, onSelect: a3.props.onSelect, setOpen: a3.props.setOpen, dropdownMode: a3.props.dropdownMode, onChange: a3.changeYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, year: getYear(a3.state.date), scrollableYearDropdown: a3.props.scrollableYearDropdown, yearDropdownItemNumber: a3.props.yearDropdownItemNumber });
    })), ye(ke(a3), "renderMonthDropdown", (function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthDropdown && !t5) return import_react2.default.createElement(Nt, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, onChange: a3.changeMonth, month: getMonth(a3.state.date), useShortMonthInDropdown: a3.props.useShortMonthInDropdown });
    })), ye(ke(a3), "renderMonthYearDropdown", (function() {
      var t5 = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
      if (a3.props.showMonthYearDropdown && !t5) return import_react2.default.createElement(Ot, { dropdownMode: a3.props.dropdownMode, locale: a3.props.locale, dateFormat: a3.props.dateFormat, onChange: a3.changeMonthYear, minDate: a3.props.minDate, maxDate: a3.props.maxDate, date: a3.state.date, scrollableMonthYearDropdown: a3.props.scrollableMonthYearDropdown });
      ...
      if (a3.props.showTimeInput) return import_react2.default.createElement(Kt, { date: t5, timeString: r2, timeInputLabel: a3.props.timeInputLabel, onChange: a3.props.onTimeChange, customTimeInput: a3.props.customTimeInput });
...
var zt = (function(t3) {
  ...
  function a3(t4) {
    ...
    return he(this, a3), ye(ke(s3 = o.call(this, t4)), "getPreSelection", (function() {
      ...
      })), s3.props.onChangeRaw && s3.props.onChangeRaw(t5), s3.setSelected(e3, t5, false, r2), s3.setState({ isRenderAriaLiveMessage: true }), !s3.props.shouldCloseOnSelect || s3.props.showTimeSelect) s3.setPreSelection(e3);
      ...
      if (s3.props.showYearPicker) {
        if (null !== o2 && ct(getYear(o2), s3.props)) return;
      } else if (s3.props.showMonthYearPicker) {
        if (null !== o2 && st(o2, s3.props)) return;
      } else if (null !== o2 && ot(o2, s3.props)) return;
      ...
      if (e3) {
        ...
        if (t5 && r2) n = Ge(e3, s3.props.minDate, s3.props.maxDate);
        else if (t5) {
      ...
      } else "ArrowDown" !== t5 && "ArrowUp" !== t5 && "Enter" !== t5 || s3.onInputClick();
      ...
      if ("Enter" === t5) e3.preventDefault(), s3.handleSelect(r2, e3), !s3.props.shouldCloseOnSelect && s3.setPreSelection(r2);
      else if ("Escape" === t5) e3.preventDefault(), s3.setOpen(false), s3.inputOk() || s3.props.onInputError({ code: 1, msg: "Date input not valid." });
        ...
        if (!n) return void (s3.props.onInputError && s3.props.onInputError({ code: 1, msg: "Date input not valid." }));
